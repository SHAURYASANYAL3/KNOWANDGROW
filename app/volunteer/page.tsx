      ...
      <section className="section-bg py-20 sm:py-24">
        <div className="container grid gap-10 lg:grid-cols-[1fr_0.9fr] lg:items-center">
          <div className="space-y-6">
            ...
            <p className="max-w-2xl text-base leading-8 text-slate-300">Volunteers help create safe spaces, run workshops, and offer steady support for young people finding their way.</p>
          </div>
