    ...
    <main className="min-h-screen bg-brand-950 text-slate-100">
      ...
      <section className="section-bg py-20 sm:py-24">
        <div className="container space-y-8">
          ...
          <p className="max-w-3xl text-sm leading-7 text-slate-300">Our approach is designed for trust, with a strong focus on minimal data and respectful handling.</p>
        </div>
      </section>
      ...
      <section className="bg-slate-900/80 py-16">
        <div className="container rounded-[3rem] border border-white/10 bg-slate-950/90 p-10 shadow-soft sm:p-14">
          ...
          <p className="mt-6 max-w-2xl text-base leading-8 text-slate-300">We keep data handling transparent and simple so you can focus on support, learning, and community.</p>
        </div>
      </section>
