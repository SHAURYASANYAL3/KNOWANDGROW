    ...
    <main className="min-h-screen bg-brand-950 text-slate-100">
      ...
      <section className="section-bg py-20 sm:py-24">
        <div className="container grid gap-10 lg:grid-cols-[1fr_0.95fr] lg:items-center">
          <div className="space-y-6">
            ...
            <p className="max-w-2xl text-base leading-8 text-slate-300">Our programs offer clear information without judgment, helping youth talk about substance use with confidence.</p>
          </div>
      ...
      <section className="bg-gradient-to-b from-slate-950 to-brand-900 py-20">
        <div className="container rounded-[3rem] border border-white/10 bg-slate-950/90 p-10 shadow-soft sm:p-14">
          ...
          <p className="mt-6 max-w-2xl text-base leading-8 text-slate-300">We provide context, compassion, and clear action steps so young people can make choices without shame.</p>
        </div>
      </section>
