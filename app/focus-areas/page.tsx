    ...
    <main className="min-h-screen bg-brand-950 text-slate-100">
      ...
      <section className="section-bg py-20 sm:py-24">
        <div className="container space-y-8">
          ...
          <p className="max-w-3xl text-sm leading-7 text-slate-300">We combine education, compassionate communication, and practical skills to help young people make confident choices.</p>
        </div>
      </section>
      ...
      <section className="bg-slate-900/80 py-16">
        <div className="container grid gap-10 rounded-[2.5rem] border border-white/10 bg-slate-950/90 p-10 shadow-soft lg:grid-cols-[1.2fr_0.8fr]">
          <div>
            ...
            <p className="mt-6 max-w-xl text-base leading-8 text-slate-300">We aim for clarity and calm, with materials that guide young people through real decisions instead of dramatizing risk.</p>
          </div>
