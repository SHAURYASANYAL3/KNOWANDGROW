    ...
    <main className="min-h-screen bg-brand-950 text-slate-100">
      ...
      <section className="section-bg py-20 sm:py-24">
        <div className="container space-y-8">
          ...
          <p className="max-w-3xl text-sm leading-7 text-slate-300">We encourage you to reach out to professionals or a trusted adult if you feel unsafe or overwhelmed.</p>
        </div>
      </section>
      ...
      <section className="bg-slate-900/80 py-16">
        <div className="container rounded-[3rem] border border-white/10 bg-slate-950/90 p-10 shadow-soft">
          <div className="grid gap-8 lg:grid-cols-[1fr_0.8fr] lg:items-center">
            <div>
              ...
              <p className="mt-6 max-w-xl text-base leading-8 text-slate-300">It is okay to reach out. You deserve care, understanding, and a space that respects your voice.</p>
            </div>
            <div className="rounded-[2rem] border border-white/10 bg-slate-900/95 p-8">
              ...
              <p className="mt-3 text-sm leading-7 text-slate-400">If you are facing an immediate crisis, please contact local services right away.</p>
            </div>
          </div>
        </div>
      </section>
