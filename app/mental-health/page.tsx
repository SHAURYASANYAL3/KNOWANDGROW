    ...
    <main className="min-h-screen bg-brand-950 text-slate-100">
      ...
      <section className="section-bg py-20 sm:py-24">
        <div className="container grid gap-10 lg:grid-cols-[1fr_0.9fr] lg:items-center">
          <div className="space-y-6">
            ...
            <p className="max-w-2xl text-base leading-8 text-slate-300">Our mental health programs focus on resilience, coping skills, and community understanding rather than labels or pressure.</p>
          </div>
      ...
      <section className="bg-gradient-to-b from-slate-950 to-brand-900 py-20">
        <div className="container rounded-[3rem] border border-white/10 bg-slate-950/90 p-10 shadow-soft sm:p-14">
          ...
          <p className="mt-6 max-w-2xl text-base leading-8 text-slate-300">We create learning experiences that help youth feel grounded, understood, and supported in their next step.</p>
        </div>
      </section>
